#ifndef OBJECTROTATION_H
#define OBJECTROTATION_H
...
// 8<--Snip here if you have your own math types/funcs-->8
    ...
    typedef class ObjectRotation_t
    {
        protected:
            inline
        ...
        public:
            //Create/Destroy
                    ObjectRotation_t(GLfloat NewWidth, GLfloat NewHeight);
                   ~ObjectRotation_t() { /* nothing to do */ };
